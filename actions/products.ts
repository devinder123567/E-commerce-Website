...
export async function getProducts(filters: GetProductsFilters = {}) {
  ...
  if (color) {
    query = query.overlaps('tags', [color])
  }

  if (size) {
    query = query.overlaps('tags', [size])
  }
  ...
  if (sortBy === 'price_asc') {
    ...
    // Standard query order if no average rating view exists
    query = query.order('created_at', { ascending: false })
  }
...
export async function getFeaturedProducts() {
  if (isSupabasePlaceholder()) {
    return mockDb.getFeaturedProducts()
  }
...
export async function getProductsByIds(ids: string[]) {
  if (isSupabasePlaceholder()) {
    ...
    return allProducts.filter((p: any) => ids.includes(p.id))
  }
...
// Seed Store Database
export async function seedStoreDatabase() {
  if (isSupabasePlaceholder()) {
    // Already handled/seeded locally by mockDb
    return { success: true }
  }
  ...
  const manualVariants = [
    { id: '11e51631-1234-4567-89ab-cdef01234567', product_id: '1e51631e-1234-4567-89ab-cdef01234567', name: 'Matte Black', price: 299.00, stock_quantity: 10, sku: 'TECH-001-BLK' },
    { id: '12e51631-1234-4567-89ab-cdef01234567', product_id: '1e51631e-1234-4567-89ab-cdef01234567', name: 'Platinum Silver', price: 310.00, stock_quantity: 5, sku: 'TECH-001-SLV' },
    { id: '31f61732-2345-5678-9abc-def012345678', product_id: '3f61732f-2345-5678-9abc-def012345678', name: 'Size S / Slate', price: 89.00, stock_quantity: 15, sku: 'APP-001-S' },
    { id: '32f61732-2345-5678-9abc-def012345678', product_id: '3f61732f-2345-5678-9abc-def012345678', name: 'Size M / Slate', price: 89.00, stock_quantity: 15, sku: 'APP-001-M' },
    { id: '33f61732-2345-5678-9abc-def012345678', product_id: '3f61732f-2345-5678-9abc-def012345678', name: 'Size L / Slate', price: 89.00, stock_quantity: 10, sku: 'APP-001-L' },
    { id: '13131313-1313-1313-1313-131313131313', product_id: '13333333-3333-3333-3333-333333333333', name: 'Green Tea Box', price: 15.00, stock_quantity: 100, sku: 'GROC-001-BOX' },
    { id: '14141414-1414-1414-1414-141414141414', product_id: '14444444-4444-4444-4444-444444444444', name: 'Oakwood Organizer', price: 29.00, stock_quantity: 45, sku: 'HOME-001-OAK' },
    { id: '15151515-1515-1515-1515-151515151515', product_id: '15555555-5555-5555-5555-555555555555', name: 'Charcoal Black', price: 89.00, stock_quantity: 35, sku: 'TRAV-001-BLK' }
  ]
  ...
  if (coupError) {
    ...
    throw new Error(coupError.message)
  }
